...
public class SubcategoryTest extends Base {
	...
	public void verifyUserIsAbleToAddSubcategory() throws AWTException, IOException {
		...
		subcategorypage=homepage.selectSubCategory().clickOnNewBtnOnTheSubCategoryPage().selectCategoryFromDropdown();
	...
	public void verifyUserAbleToSearchSubcategory() throws IOException
	{
		...
		homepage=loginpage.clickOnSigninButton();
		subcategorypage=homepage.selectSubCategory().clickOnSearchBtnInTheSubCategoryPage().selectSubCategoryFromTheDropdown();
